...
const existingCharacterPages = new Set(["potpourri", "rea", "sophia", "veela", "sivi", "cerberus", "aa_dark", "cattleya", "soltina", "amleth", "fenrir", "florence", "moddey", "sonya", "stella", "fenny", "tropon_holy_night", "giluial", "liselotte", "eir", "ivy", "minasumari", "nina", "nina_summer", "serruria", "eureka", "cordie", "cordie_ringmaster", "merlyn_winter", "merlin", "evelyn", "fia_trace", "sabrina", "sabrina_cool_breeze", "freycia", "amour", "lean", "chiffon", "artie", "belle", "dian", "cordie_summer", "priscilla", "matilda", "aishe", "lilicotte", "morgana", "soltina_warm_memory", "artoria", "shizu_snow", "lucile", "flack", "liebe", "mertillier", "luke"]);
