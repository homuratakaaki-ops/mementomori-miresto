...
const existingCharacterPages = new Set(["aa_dark","aa_rusted_sky","aine","aishe","alexandra","amleth","amleth_summer","amour","amour_holy_night","armstrong","artie","artoria","asahi","belle","carmilla","cattleya","cerberus","cerberus_candy","chiffon","claudia","cordie","cordie_ringmaster","cordie_summer","dd","dian","eir","elaine","elfriede","eureka","evelyn","fenny","fenrir","fenrir_treasure","fia","fia_trace","flack","florence","florence_twilight","fortina","freycia","giluial","guinevere","hathor","idyne","illya_gods_curse","irene","iris_black","ivy","kaguya","karol","kobell","lean","liebe","lilicotte","lily","liselotte","lucile","luke","lumika","lunalynn","lunalynn_holy_night","matilda","meria","merlin","merlyn","merlyn_winter","mertillier","mifuri","mimi","minasumari","mira","moddey","moddey_summer","moineau","morgana","natasha","natasha_bouquet","nebra","nina","nina_summer","olivia","ophelia","paladea","paula","potpourri","primavera","primavera_summer","priscilla","rea","regina","rishess","rivelia","rosalie_caritas","rusalka","rustica","sabrina","sabrina_cool_breeze","serruria","shiloh","shizu_snow","sivi","soltina","soltina_warm_memory","sonya","sophia","stella","stella_holy_dark_star","tama","tilly","tricksy","tropon","tropon_holy_night","valriede","wheeler","yuni","yurdiz"]);
...
async function loadData() {
  ...
  const overlays = await Promise.all([
    ...
    fetchJson("./data/lunalynn-holy-night-overlay.json", true),
    fetchJson("./data/tilly-overlay.json", true),
    fetchJson("./data/paula-overlay.json", true),
    fetchJson("./data/dd-overlay.json", true),
