...
const existingCharacterPages = new Set(["potpourri", "rea", "sophia", "veela", "sivi", "cerberus", "aa_dark", "cattleya", "soltina", "amleth", "fenrir", "florence", "moddey", "sonya", "stella", "fenny", "tropon_holy_night", "giluial", "liselotte", "eir", "minasumari", "nina_summer", "serruria", "eureka", "cordie_ringmaster", "merlyn_winter", "evelyn", "fia_trace", "sabrina", "freycia", "amour", "lean", "chiffon", "artie", "belle", "dian", "cordie_summer", "priscilla", "matilda"]);
